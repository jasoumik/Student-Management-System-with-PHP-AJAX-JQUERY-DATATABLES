...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="teacher_front.php">Teacher</a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="student_front.php">Student</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="admin_attendance.php">Attendance</a>
      </li>
      <li class="nav-item">
